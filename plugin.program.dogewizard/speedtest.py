...
I1IiI = 'plugin.program.dogewizard'
...
class O0iIiIIIIIii ( xbmcgui . WindowDialog ) :
 ...
 def saveClose ( self ) :
  OOo = xbmcgui . Dialog ( )
  OOo . ok ( "[COLOR ghostwhite][B] Speed Test Powered By Ookla[/COLOR][/B]" ,"[COLOR red]2 Mbps + For SD Content [/COLOR]", "[COLOR orange]5 Mbps + For HD Content [/COLOR]","[COLOR green]25 Mbps + For 4K Content[/COLOR]" )
  self . close ( )
  if 74 - 74: O0 / i1IIi
