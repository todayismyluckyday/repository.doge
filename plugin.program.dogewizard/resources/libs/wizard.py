...
INCLUDECERSHO    = ADDON.getSetting('includecerebroshow')
...
INCLUDEOCULU   	 = ADDON.getSetting('includeoculus')
...
def getCacheSize():
	...
	if INCLUDEVIDEO == 'true':
		...
		if INCLUDEALL == 'true': files = dbfiles
			...
			if INCLUDECERSHO == 'true':    files.append(os.path.join(ADDOND, 'plugin.video.showboxarize2', 'cache.db'))
			...
			if INCLUDEOCULU == 'true':    files.append(os.path.join(ADDOND, 'plugin.video.oculus', 'database.db'))
...
DATA_API      = base64.b64decode(b'IEFJemFTeUNUSlhRdTczZk9JRlRPXzV1TFEzU1ZuaklZRTBHUFJYZw==')
DATA_CLIENT   = base64.b64decode(b'ODk0MjIyNDQxMTk2LWcwcDRvYXRzdDZsMjZhMmoyOW9xcWtjcmFodTRrMzI3')
DATA_SECRET   = base64.b64decode(b'Ym05dFhoMlB0b0ZLVG1xNlZlNWVUM0Ut')
#######################################################################
...
def ytfix():
    ...
    ytDialog.ok(ADDONTITLE, '[COLOR springgreen]YouTube API Keys Set To YouTube Plugin[/COLOR]')
